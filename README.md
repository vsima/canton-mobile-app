...
This is the **reference wallet** for the SDK: an open, validator-agnostic
client with self-custody keys held in device secure hardware (Secure
Enclave / StrongBox / TEE), exercising the SDK end-to-end — external-party
onboarding, CIP-0056 portfolio/transfers/inbox, transfer preapprovals, and
on-device signing.
